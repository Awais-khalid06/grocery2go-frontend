...
export const locationStyles = StyleSheet.create({
  ...
  selectionLocationMapText: {
    fontFamily: FONTS.medium,
    color: "rgba(18, 111, 207, 1)",
  },
...
export const orderDetailStyles = StyleSheet.create({
  ...
  sectionSpacing: { marginTop: 15, gap: 10 },
  sectionLabelGroup: { gap: 4 },
  sectionSubText: { color: COLORS.textGray, lineHeight: 18 },
  deliveryTimeBlock: { marginTop: 15, gap: 8 },
  deliveryTimeInputContainer: { width: "100%" },
  statusPill: {
  ...
  statusPillSuccess: { backgroundColor: "rgba(29, 197, 96, 0.12)" },
  statusPillDanger: { backgroundColor: "rgba(255, 77, 79, 0.12)" },
  statusPillInfo: { backgroundColor: "rgba(14, 160, 232, 0.12)" },
  statusPillNeutral: { backgroundColor: "rgba(127, 127, 127, 0.12)" },
  statusPillText: { fontFamily: FONTS.medium, fontSize: 11 },
  statusPillTextSuccess: { color: COLORS.green },
  statusPillTextDanger: { color: COLORS.danger },
  statusPillTextInfo: { color: COLORS.blue },
  statusPillTextNeutral: { color: COLORS.textGray },
  distanceItem: { flexDirection: "row", alignItems: "center", gap: 10 },
  distanceDotsBar: {
    height: 40,
    borderLeftWidth: 1,
    marginStart: 20,
    borderStyle: isIOS ? undefined : "dotted",
    borderColor: COLORS.primary,
  },
  billItemContainer: {
    backgroundColor: COLORS.white,
  ...
  billItemContainer2: {
    backgroundColor: "rgba(255, 45, 8, 0.25)",
    width: "40%",
    alignItems: "flex-end",
    padding: 10,
    gap: 15,
...
export const listStyles = StyleSheet.create({
  ...
  pageIntroTitle: { fontFamily: FONTS.semiBold, fontSize: 18 },
  pageIntroSubtitle: { color: COLORS.textGray, lineHeight: 18 },
  emptyStateCard: {
    backgroundColor: COLORS.white,
    borderRadius: 18,
    padding: 20,
  ...
  listFloatingButton: {
    ...
    borderWidth: 1,
    borderColor: COLORS.primary,
    ...globalStyles.boxShadow2,
  },
  listFloatingButtonText: {
    color: COLORS.primary,
    fontFamily: FONTS.semiBold,
  },
  addListHeaderInputContainer: { gap: 5 },
  addListHeaderQuantityInput: {
    flexDirection: "row",
    alignItems: "center",
    gap: 10,
  },
  addButton: { height: 40, width: "25%" },
  productsContainer: { marginTop: 18, gap: 12, flex: 1 },
  formCard: {
    backgroundColor: COLORS.white,
    borderRadius: 16,
    padding: 16,
  ...
  formSectionHeader: { gap: 4 },
  formSectionTitle: { fontFamily: FONTS.semiBold, fontSize: 16 },
  formSectionSubtitle: { color: COLORS.textGray, lineHeight: 18 },
  builderCard: {
    backgroundColor: COLORS.lightblue,
    borderRadius: 14,
    padding: 14,
  ...
  productRowField: { flex: 1 },
  productRowQuantityField: { width: "34%" },
  productDeleteButton: {
    width: 36,
    height: 36,
    borderRadius: 12,
  ...
  builderField: { flex: 1 },
  builderButton: { width: "100%", height: 45 },
  builderButtonText: { fontSize: 13 },
  listDetailSummaryCard: {
    backgroundColor: COLORS.white,
    borderRadius: 16,
    padding: 16,
    gap: 10,
  ...
  listDetailTitleContainer: { flex: 1, gap: 4 },
  listDetailMetaRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  listDetailMetaPillText: {
    color: COLORS.secondary,
    fontFamily: FONTS.medium,
    fontSize: 11,
  },
  listDetailMetaPillMuted: {
    backgroundColor: "rgba(127, 127, 127, 0.12)",
    paddingHorizontal: 10,
    paddingVertical: 4,
    borderRadius: 999,
  },
  listDetailMetaPillMutedText: {
    color: COLORS.textGray,
    fontFamily: FONTS.medium,
    fontSize: 11,
  },
  ...
  detailListContent: { flex: 1, gap: 2 },
  detailQuantityPill: {
    minWidth: 64,
    paddingHorizontal: 10,
    paddingVertical: 4,
  ...
  deleteSheetButton: { flex: 1, height: 45 },
  deleteSheetButtonText: { fontSize: 13 },
  productCounter: {
    borderWidth: 1,
    borderRadius: 5,
    borderColor: COLORS.grey2,
